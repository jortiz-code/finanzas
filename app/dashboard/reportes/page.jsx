      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-1">Análisis de tus finanzas</p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900 rounded-2xl p-6">
              <h2 className="text-xl font-semibold mb-6">Gastos por categoría este mes</h2>
              {datosTorta.length === 0 ? (
            ...
            <div className="bg-gray-900 rounded-2xl p-6">
              <h2 className="text-xl font-semibold mb-6">Últimos 6 meses</h2>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={gastosMes} margin={{ top: 5, right: 20, left: 20, bottom: 5 }}>
            ...
            {/* Top categorías */}
            <div className="bg-gray-900 rounded-2xl p-6">
              <h2 className="text-xl font-semibold mb-4">Top categorías del mes</h2>
                ...
                {gastosCategoria
                  ...
                  .map((g, i) => (
                    <div key={i} className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-red-400">{formatMonto(g.total_gastado)}</span>
                    </div>
                  ))}
              </div>
            </div>
